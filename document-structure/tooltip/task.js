...
//лучше было обрабатывать клик по ссылке. 
//В таком случае обработчик события обрабатывался гораздо реже. 
//Так же в первом задании лучше было иметь один элемент подсказки, 
//который позиционировать, менять текст и отображение.